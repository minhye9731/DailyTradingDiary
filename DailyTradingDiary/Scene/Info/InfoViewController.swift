...
//        self.mainView.tableView.isSkeletonable = true
        self.connectAPI()
        
//        let skeletonAnimation = SkeletonAnimationBuilder().makeSlidingAnimation(withDirection: .leftRight)
//        self.mainView.tableView.showAnimatedGradientSkeleton(usingGradient: .init(colors: [.lightGray, .pointColor]), animation: skeletonAnimation, transition: .none)
...
extension InfoViewController:  UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        case 0: return 150 // self.view.frame.width
        case 1: return 120
        default: return 1
        }
    }
...
//        self.mainView.tableView.isSkeletonable = true
//
////        self.mainView.tableView.estimatedRowHeight = 160
//
////
//    }
//
...
//
//        let skeletonAnimation = SkeletonAnimationBuilder().makeSlidingAnimation(withDirection: .leftRight)
//        self.mainView.tableView.showAnimatedGradientSkeleton(usingGradient: .init(colors: [.lightGray, .darkGray]), animation: skeletonAnimation, transition: .none)
//        self.fetchDataSource()
//    }
//
//    override func configure() {
...
//            self.connectAPI()
//            self.mainView.tableView.reloadData()
//            self.mainView.tableView.hideSkeleton(reloadDataAfter: true, transition: .crossDissolve(0.5))
//        }
//    }
//
//    func setNav() {
...
//
//// MARK: - skeleton view 적용한 tableview
//extension InfoViewController: SkeletonTableViewDataSource, UITableViewDataSource {
//
//    func numberOfSections(in tableView: UITableView) -> Int {
//        return 2
//    }
...
//    func collectionSkeletonView(_ skeletonView: UITableView, cellIdentifierForRowAt indexPath: IndexPath) -> ReusableCellIdentifier {
//        switch indexPath.section {
//        case 0: return FearGreedGraphTableViewCell.reuseIdentifier
//        case 1: return NewsTableViewCell.reuseIdentifier
//        default: return NewsTableViewCell.reuseIdentifier
//        }
//    }
//
//    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
...
//}
//
//extension InfoViewController: SkeletonTableViewDelegate, UITableViewDelegate {
//
//    func collectionSkeletonView(_ skeletonView: UITableView, identifierForHeaderInSection section: Int) -> ReusableHeaderFooterIdentifier? {
//        switch section {
//        case 0: return CustomTableViewHeaderView.reuseIdentifier
//        case 1: return CustomTableViewHeaderView.reuseIdentifier
//        default: return CustomTableViewHeaderView.reuseIdentifier
//        }
//    }
//
//    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
